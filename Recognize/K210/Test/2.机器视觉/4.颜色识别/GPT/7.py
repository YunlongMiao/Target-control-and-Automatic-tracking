...
while(True):
    ...
    opv_find_blobs(yellow,3)                                # 找黑色色块 led标志为1 表示黑色
    opv_find_blobs(blue,4)
    opv_find_blobs(white,5)                                # 找黑色色块 led标志为1 表示黑色
    opv_find_blobs(green,6)
    ...
    if mycnt == 0:                                          # 如果 mycnt 等于 0 此步骤的目的是控制打印周期 不要打印的太快
        ...
        print_blobs_property(yellow,"yellow-")                # 打印黑色色块参数
        print_blobs_property(green,  "green-  ")                # 打印红色色块参数
        print_blobs_property(blue,"blue-")                # 打印黑色色块参数
        print_blobs_property(white,  "white-  ")                # 打印红色色块参数
